...
if __name__ == "__main__":
    ...
    parser.add_argument("--server", default="ws://turboui.inf-pg1-np.automotive.local/relay",
                        help="MCP server WebSocket URL (default: ws://turboui.inf-pg1-np.automotive.local/relay)")
