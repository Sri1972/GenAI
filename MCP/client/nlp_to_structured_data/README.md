# 🚀 NLP to Structured Data - AI-Powered Data Analysis Client

**Transform your data conversations with Claude AI via Model Context Protocol**

**🗂️ Note**: This is the client component located at `D:\GenAI\MCP\client\nlp_to_structured_data\`
**Server**: The MCP server is located at `D:\GenAI\MCP\server\nlp_to_structured_data\`
